...
import data from './components/doob';
...
const {name, moto, intro, short_profession, profession, phone, location, hero_img, logo_img, about_img, brand_logo, menus, projects, skills, feedbacks, blogs, footer_services, footer_projects}=data;
...
const App=()=>{
  ...
  return (<div id="main_wrapper" className="bg-white w-screen flex flex-col font-inter dark:bg-black">
    ...
    <Headers logo_img={logo_img} menus={menus} toggleDark={toggleDark} toggleSidebar={toggleSidebar}/>
    <Hero name={name} hero_img={hero_img}/>
    <Card short_profession={short_profession} intro={intro} profession={profession} phone={phone} location={location} about_img={about_img}/>
