...
import Sidebar from "./components/SidebarDev.jsx";
...
// import MenuChange from "./components/ModelBox/MenuChange.jsx";
    ...
    >
      ...
      <div>
        <div className="group relative">
          <div className="bg-opacity-50 backdrop-blur-lg hidden bg-teal-50a0 w-screen h-full z-40 group-hover:absolute group-hover:inline-block">
      ...
      {/* <div className="group"> */}
      {/* <div className="hidden absolute group-hover:inline-block bg-teal-500">

</div> */}
      <Hero name={Data['name']} hero_img={Data['hero_img']} changeName={changeName} />
      <div>
        <div className="group relative">
        <div className="bg-opacity-50 backdrop-blur-lg hidden bg-teal-50a0 w-screen h-full z-10 group-hover:absolute group-hover:inline-block -top-40">
            <div className="flex flex-col justify-center items-center h-full">
      ...
      <div>
        <div className="group relative">
          <div className="bg-opacity-50 backdrop-blur-lg hidden w-screen h-full z-20 group-hover:absolute group-hover:inline-block">
            <div className="flex flex-col justify-center items-center h-full">
              <button className="flex flex-row justify-evenly items-center p-2 rounded-md h-10 w-36 bg-green-500 text-white">
              <span>Edit Item</span>
              <span
              className="material-symbols-outlined text-xl"
              id="sideBarButton"
