const Feedbacks=(props)=>{
    ...
    <div className="py-20 flex flex-col items-center border-b-2">
        ...
        <h5 className="w-80 text-center tracking-widest text-gray-300 mb-10 dark:text-gray-300">We provide company and finance service for startups and company business.</h5>
